...
class Trainer:
    ...
    def train(self):
        ...
        try:
            ...
            should_abort.fill_(1)
            dist.all_reduce(should_abort, op=dist.ReduceOp.MAX)
            
            if should_abort.item() == 1:
                ...
                try:
                    ...
                    self.logger.error(f"[Rank {self._get_local_rank()}] Error during cleanup: {cleanup_err}")
