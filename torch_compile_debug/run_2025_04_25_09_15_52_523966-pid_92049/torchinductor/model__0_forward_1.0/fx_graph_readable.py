class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[10000, 256]", primals_2: "i64[16, 512]", primals_3: "f32[1, 512, 256]", primals_4: "f32[256]", primals_5: "f32[256, 256]", primals_6: "f32[256]", primals_7: "f32[32, 256]", primals_8: "f32[32]", primals_9: "f32[256, 256]", primals_10: "f32[256]", primals_11: "f16[512, 32]", primals_12: "f16[512, 32]", primals_13: "b8[1, 1, 512, 512]", primals_14: "f32[256]", primals_15: "f32[682, 256]", primals_16: "f32[682]", primals_17: "f32[682, 256]", primals_18: "f32[682]", primals_19: "f32[256, 682]", primals_20: "f32[256]", primals_21: "f32[256]", primals_22: "f32[256, 256]", primals_23: "f32[256]", primals_24: "f32[32, 256]", primals_25: "f32[32]", primals_26: "f32[256, 256]", primals_27: "f32[256]", primals_28: "f16[512, 32]", primals_29: "f16[512, 32]", primals_30: "b8[1, 1, 512, 512]", primals_31: "f32[256]", primals_32: "f32[682, 256]", primals_33: "f32[682]", primals_34: "f32[682, 256]", primals_35: "f32[682]", primals_36: "f32[256, 682]", primals_37: "f32[256]", primals_38: "f32[256]", primals_39: "f32[256, 256]", primals_40: "f32[256]", primals_41: "f32[32, 256]", primals_42: "f32[32]", primals_43: "f32[256, 256]", primals_44: "f32[256]", primals_45: "f16[512, 32]", primals_46: "f16[512, 32]", primals_47: "b8[1, 1, 512, 512]", primals_48: "f32[256]", primals_49: "f32[682, 256]", primals_50: "f32[682]", primals_51: "f32[682, 256]", primals_52: "f32[682]", primals_53: "f32[256, 682]", primals_54: "f32[256]", primals_55: "f32[256]", primals_56: "f32[256, 256]", primals_57: "f32[256]", primals_58: "f32[32, 256]", primals_59: "f32[32]", primals_60: "f32[256, 256]", primals_61: "f32[256]", primals_62: "f16[512, 32]", primals_63: "f16[512, 32]", primals_64: "b8[1, 1, 512, 512]", primals_65: "f32[256]", primals_66: "f32[682, 256]", primals_67: "f32[682]", primals_68: "f32[682, 256]", primals_69: "f32[682]", primals_70: "f32[256, 682]", primals_71: "f32[256]", primals_72: "f32[256]", primals_73: "f32[10000]"):
        ...
        embedding: "f32[16, 512, 256]" = torch.ops.aten.embedding.default(primals_1, primals_2)
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:880 in forward, code: x_pe = x + self.positional_embedding[:, :x.size(1), :]
        ...
        view: "f32[8192, 256]" = torch.ops.aten.view.default(mul_1, [8192, 256]);  mul_1 = None
        ...
        view_1: "f32[16, 512, 256]" = torch.ops.aten.view.default(addmm, [16, 512, 256]);  addmm = None
        ...
        view_3: "f32[16, 512, 32]" = torch.ops.aten.view.default(addmm_1, [16, 512, 32]);  addmm_1 = None
        ...
        view_5: "f32[16, 512, 256]" = torch.ops.aten.view.default(addmm_2, [16, 512, 256]);  addmm_2 = None
        ...
        view_6: "f32[16, 8, 512, 32]" = torch.ops.aten.view.default(view_1, [16, 8, 512, 32]);  view_1 = None
        ...
        view_7: "f32[16, 8, 512, 32]" = torch.ops.aten.view.default(view_5, [16, 8, 512, 32]);  view_5 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:977 in forward, code: cos = self.rope_cos[:x.shape[2]]
        slice_3: "f16[512, 32]" = torch.ops.aten.slice.Tensor(primals_11, 0, 0, 512);  primals_11 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:978 in forward, code: sin = self.rope_sin[:x.shape[2]]
        slice_4: "f16[512, 32]" = torch.ops.aten.slice.Tensor(primals_12, 0, 0, 512);  primals_12 = None
        ...
        unsqueeze_1: "f16[1, 512, 32]" = torch.ops.aten.unsqueeze.default(slice_3, 0);  slice_3 = None
        unsqueeze_2: "f16[1, 1, 512, 32]" = torch.ops.aten.unsqueeze.default(unsqueeze_1, 0);  unsqueeze_1 = None
        ...
        unsqueeze_3: "f16[1, 512, 32]" = torch.ops.aten.unsqueeze.default(slice_4, 0);  slice_4 = None
        unsqueeze_4: "f16[1, 1, 512, 32]" = torch.ops.aten.unsqueeze.default(unsqueeze_3, 0);  unsqueeze_3 = None
        ...
        slice_7: "f16[1, 1, 512, 16]" = torch.ops.aten.slice.Tensor(unsqueeze_2, 3, 0, 9223372036854775807, 2);  unsqueeze_2 = None
        ...
        slice_8: "f16[1, 1, 512, 16]" = torch.ops.aten.slice.Tensor(unsqueeze_4, 3, 0, 9223372036854775807, 2);  unsqueeze_4 = None
        ...
        view_8: "f32[16, 8, 512, 32]" = torch.ops.aten.view.default(cat, [16, 8, 512, 32]);  cat = None
        ...
        slice_12: "f32[16, 1, 512, 16]" = torch.ops.aten.slice.Tensor(unsqueeze, 3, 1, 9223372036854775807, 2);  unsqueeze = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:999 in forward, code: rotated_x_even = x_even * cos_even - x_odd * sin_even
        mul_6: "f32[16, 1, 512, 16]" = torch.ops.aten.mul.Tensor(slice_11, slice_7)
        mul_7: "f32[16, 1, 512, 16]" = torch.ops.aten.mul.Tensor(slice_12, slice_8)
        sub_1: "f32[16, 1, 512, 16]" = torch.ops.aten.sub.Tensor(mul_6, mul_7);  mul_6 = mul_7 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:1000 in forward, code: rotated_x_odd = x_even * sin_even + x_odd * cos_even
        mul_8: "f32[16, 1, 512, 16]" = torch.ops.aten.mul.Tensor(slice_11, slice_8);  slice_11 = None
        mul_9: "f32[16, 1, 512, 16]" = torch.ops.aten.mul.Tensor(slice_12, slice_7);  slice_12 = None
        ...
        cat_1: "f32[16, 1, 512, 16, 2]" = torch.ops.aten.cat.default([unsqueeze_11, unsqueeze_12], -1);  unsqueeze_11 = unsqueeze_12 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:1003 in forward, code: rotated = rotated.flatten(-2)
        view_9: "f32[16, 1, 512, 32]" = torch.ops.aten.view.default(cat_1, [16, 1, 512, 32]);  cat_1 = None
        ...
        view_10: "f32[128, 512, 32]" = torch.ops.aten.view.default(expand, [128, 512, 32]);  expand = None
        ...
        view_12: "f32[16, 8, 512, 512]" = torch.ops.aten.view.default(bmm, [16, 8, 512, 512]);  bmm = None
        ...
        view_13: "f32[128, 512, 512]" = torch.ops.aten.view.default(expand_2, [128, 512, 512]);  expand_2 = None
        expand_3: "f32[16, 8, 512, 32]" = torch.ops.aten.expand.default(view_7, [16, 8, 512, 32]);  view_7 = None
        view_14: "f32[128, 512, 32]" = torch.ops.aten.view.default(expand_3, [128, 512, 32]);  expand_3 = None
        bmm_1: "f32[128, 512, 32]" = torch.ops.aten.bmm.default(view_13, view_14);  view_13 = None
        view_15: "f32[16, 8, 512, 32]" = torch.ops.aten.view.default(bmm_1, [16, 8, 512, 32]);  bmm_1 = None
        view_16: "f32[16, 512, 256]" = torch.ops.aten.view.default(view_15, [16, -1, 256]);  view_15 = None
        ...
        view_17: "f32[8192, 256]" = torch.ops.aten.view.default(mul_11, [8192, 256])
        ...
        view_18: "f32[16, 512, 682]" = torch.ops.aten.view.default(addmm_3, [16, 512, 682])
        ...
        view_20: "f32[16, 512, 682]" = torch.ops.aten.view.default(addmm_4, [16, 512, 682])
        ...
        view_21: "f32[8192, 682]" = torch.ops.aten.view.default(mul_13, [8192, 682]);  mul_13 = None
        ...
        view_22: "f32[16, 512, 256]" = torch.ops.aten.view.default(addmm_5, [16, 512, 256]);  addmm_5 = None
        ...
        mul_15: "f32[16, 512, 256]" = torch.ops.aten.mul.Tensor(mul_14, primals_21);  mul_14 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:94 in forward, code: q = self.linearQ(x)
        view_23: "f32[8192, 256]" = torch.ops.aten.view.default(mul_15, [8192, 256]);  mul_15 = None
        ...
        view_24: "f32[16, 512, 256]" = torch.ops.aten.view.default(addmm_6, [16, 512, 256]);  addmm_6 = None
        ...
        view_26: "f32[16, 512, 32]" = torch.ops.aten.view.default(addmm_7, [16, 512, 32]);  addmm_7 = None
        ...
        view_28: "f32[16, 512, 256]" = torch.ops.aten.view.default(addmm_8, [16, 512, 256]);  addmm_8 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:536 in forward, code: q = q.view(b, self.n_heads, q_l, self.d_head)
        view_29: "f32[16, 8, 512, 32]" = torch.ops.aten.view.default(view_24, [16, 8, 512, 32]);  view_24 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:537 in forward, code: k = k.unsqueeze(1)
        unsqueeze_13: "f32[16, 1, 512, 32]" = torch.ops.aten.unsqueeze.default(view_26, 1);  view_26 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:538 in forward, code: v = v.view(b, self.n_heads, v_l, self.d_head)
        view_30: "f32[16, 8, 512, 32]" = torch.ops.aten.view.default(view_28, [16, 8, 512, 32]);  view_28 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:977 in forward, code: cos = self.rope_cos[:x.shape[2]]
        slice_17: "f16[512, 32]" = torch.ops.aten.slice.Tensor(primals_28, 0, 0, 512);  primals_28 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:978 in forward, code: sin = self.rope_sin[:x.shape[2]]
        slice_18: "f16[512, 32]" = torch.ops.aten.slice.Tensor(primals_29, 0, 0, 512);  primals_29 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:990 in forward, code: cos = cos.unsqueeze(0).unsqueeze(0)
        unsqueeze_14: "f16[1, 512, 32]" = torch.ops.aten.unsqueeze.default(slice_17, 0);  slice_17 = None
        unsqueeze_15: "f16[1, 1, 512, 32]" = torch.ops.aten.unsqueeze.default(unsqueeze_14, 0);  unsqueeze_14 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:991 in forward, code: sin = sin.unsqueeze(0).unsqueeze(0)
        unsqueeze_16: "f16[1, 512, 32]" = torch.ops.aten.unsqueeze.default(slice_18, 0);  slice_18 = None
        unsqueeze_17: "f16[1, 1, 512, 32]" = torch.ops.aten.unsqueeze.default(unsqueeze_16, 0);  unsqueeze_16 = None
        ...
        slice_20: "f32[16, 8, 512, 16]" = torch.ops.aten.slice.Tensor(view_29, 3, 1, 9223372036854775807, 2);  view_29 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:996 in forward, code: cos_even = cos[..., 0::2]
        slice_21: "f16[1, 1, 512, 16]" = torch.ops.aten.slice.Tensor(unsqueeze_15, 3, 0, 9223372036854775807, 2);  unsqueeze_15 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:997 in forward, code: sin_even = sin[..., 0::2]
        slice_22: "f16[1, 1, 512, 16]" = torch.ops.aten.slice.Tensor(unsqueeze_17, 3, 0, 9223372036854775807, 2);  unsqueeze_17 = None
        ...
        cat_2: "f32[16, 8, 512, 16, 2]" = torch.ops.aten.cat.default([unsqueeze_18, unsqueeze_19], -1);  unsqueeze_18 = unsqueeze_19 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:1003 in forward, code: rotated = rotated.flatten(-2)
        view_31: "f32[16, 8, 512, 32]" = torch.ops.aten.view.default(cat_2, [16, 8, 512, 32]);  cat_2 = None
        ...
        slice_26: "f32[16, 1, 512, 16]" = torch.ops.aten.slice.Tensor(unsqueeze_13, 3, 1, 9223372036854775807, 2);  unsqueeze_13 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:999 in forward, code: rotated_x_even = x_even * cos_even - x_odd * sin_even
        mul_20: "f32[16, 1, 512, 16]" = torch.ops.aten.mul.Tensor(slice_25, slice_21)
        mul_21: "f32[16, 1, 512, 16]" = torch.ops.aten.mul.Tensor(slice_26, slice_22)
        sub_4: "f32[16, 1, 512, 16]" = torch.ops.aten.sub.Tensor(mul_20, mul_21);  mul_20 = mul_21 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:1000 in forward, code: rotated_x_odd = x_even * sin_even + x_odd * cos_even
        mul_22: "f32[16, 1, 512, 16]" = torch.ops.aten.mul.Tensor(slice_25, slice_22);  slice_25 = None
        mul_23: "f32[16, 1, 512, 16]" = torch.ops.aten.mul.Tensor(slice_26, slice_21);  slice_26 = None
        ...
        cat_3: "f32[16, 1, 512, 16, 2]" = torch.ops.aten.cat.default([unsqueeze_24, unsqueeze_25], -1);  unsqueeze_24 = unsqueeze_25 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:1003 in forward, code: rotated = rotated.flatten(-2)
        view_32: "f32[16, 1, 512, 32]" = torch.ops.aten.view.default(cat_3, [16, 1, 512, 32]);  cat_3 = None
        ...
        view_33: "f32[128, 512, 32]" = torch.ops.aten.view.default(expand_4, [128, 512, 32]);  expand_4 = None
        ...
        view_34: "f32[128, 32, 512]" = torch.ops.aten.view.default(clone_2, [128, 32, 512]);  clone_2 = None
        bmm_2: "f32[128, 512, 512]" = torch.ops.aten.bmm.default(view_33, view_34)
        view_35: "f32[16, 8, 512, 512]" = torch.ops.aten.view.default(bmm_2, [16, 8, 512, 512]);  bmm_2 = None
        ...
        view_36: "f32[128, 512, 512]" = torch.ops.aten.view.default(expand_6, [128, 512, 512]);  expand_6 = None
        expand_7: "f32[16, 8, 512, 32]" = torch.ops.aten.expand.default(view_30, [16, 8, 512, 32]);  view_30 = None
        view_37: "f32[128, 512, 32]" = torch.ops.aten.view.default(expand_7, [128, 512, 32]);  expand_7 = None
        bmm_3: "f32[128, 512, 32]" = torch.ops.aten.bmm.default(view_36, view_37);  view_36 = None
        view_38: "f32[16, 8, 512, 32]" = torch.ops.aten.view.default(bmm_3, [16, 8, 512, 32]);  bmm_3 = None
        view_39: "f32[16, 512, 256]" = torch.ops.aten.view.default(view_38, [16, -1, 256]);  view_38 = None
        ...
        mul_25: "f32[16, 512, 256]" = torch.ops.aten.mul.Tensor(mul_24, primals_31);  mul_24 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:820 in forward, code: x = torch.mul(F.silu(self.swiglu_linear(x)), self.swiglu_gate_linear(x))
        view_40: "f32[8192, 256]" = torch.ops.aten.view.default(mul_25, [8192, 256])
        ...
        view_41: "f32[16, 512, 682]" = torch.ops.aten.view.default(addmm_9, [16, 512, 682])
        ...
        view_43: "f32[16, 512, 682]" = torch.ops.aten.view.default(addmm_10, [16, 512, 682])
        mul_27: "f32[16, 512, 682]" = torch.ops.aten.mul.Tensor(mul_26, view_43);  mul_26 = view_43 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:821 in forward, code: x = self.linear_out(x)
        view_44: "f32[8192, 682]" = torch.ops.aten.view.default(mul_27, [8192, 682]);  mul_27 = None
        ...
        view_45: "f32[16, 512, 256]" = torch.ops.aten.view.default(addmm_11, [16, 512, 256]);  addmm_11 = None
        ...
        mul_29: "f32[16, 512, 256]" = torch.ops.aten.mul.Tensor(mul_28, primals_38);  mul_28 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:94 in forward, code: q = self.linearQ(x)
        view_46: "f32[8192, 256]" = torch.ops.aten.view.default(mul_29, [8192, 256]);  mul_29 = None
        ...
        view_47: "f32[16, 512, 256]" = torch.ops.aten.view.default(addmm_12, [16, 512, 256]);  addmm_12 = None
        ...
        view_49: "f32[16, 512, 32]" = torch.ops.aten.view.default(addmm_13, [16, 512, 32]);  addmm_13 = None
        ...
        view_51: "f32[16, 512, 256]" = torch.ops.aten.view.default(addmm_14, [16, 512, 256]);  addmm_14 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:536 in forward, code: q = q.view(b, self.n_heads, q_l, self.d_head)
        view_52: "f32[16, 8, 512, 32]" = torch.ops.aten.view.default(view_47, [16, 8, 512, 32]);  view_47 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:537 in forward, code: k = k.unsqueeze(1)
        unsqueeze_26: "f32[16, 1, 512, 32]" = torch.ops.aten.unsqueeze.default(view_49, 1);  view_49 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:538 in forward, code: v = v.view(b, self.n_heads, v_l, self.d_head)
        view_53: "f32[16, 8, 512, 32]" = torch.ops.aten.view.default(view_51, [16, 8, 512, 32]);  view_51 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:977 in forward, code: cos = self.rope_cos[:x.shape[2]]
        slice_31: "f16[512, 32]" = torch.ops.aten.slice.Tensor(primals_45, 0, 0, 512);  primals_45 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:978 in forward, code: sin = self.rope_sin[:x.shape[2]]
        slice_32: "f16[512, 32]" = torch.ops.aten.slice.Tensor(primals_46, 0, 0, 512);  primals_46 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:990 in forward, code: cos = cos.unsqueeze(0).unsqueeze(0)
        unsqueeze_27: "f16[1, 512, 32]" = torch.ops.aten.unsqueeze.default(slice_31, 0);  slice_31 = None
        unsqueeze_28: "f16[1, 1, 512, 32]" = torch.ops.aten.unsqueeze.default(unsqueeze_27, 0);  unsqueeze_27 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:991 in forward, code: sin = sin.unsqueeze(0).unsqueeze(0)
        unsqueeze_29: "f16[1, 512, 32]" = torch.ops.aten.unsqueeze.default(slice_32, 0);  slice_32 = None
        unsqueeze_30: "f16[1, 1, 512, 32]" = torch.ops.aten.unsqueeze.default(unsqueeze_29, 0);  unsqueeze_29 = None
        ...
        slice_34: "f32[16, 8, 512, 16]" = torch.ops.aten.slice.Tensor(view_52, 3, 1, 9223372036854775807, 2);  view_52 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:996 in forward, code: cos_even = cos[..., 0::2]
        slice_35: "f16[1, 1, 512, 16]" = torch.ops.aten.slice.Tensor(unsqueeze_28, 3, 0, 9223372036854775807, 2);  unsqueeze_28 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:997 in forward, code: sin_even = sin[..., 0::2]
        slice_36: "f16[1, 1, 512, 16]" = torch.ops.aten.slice.Tensor(unsqueeze_30, 3, 0, 9223372036854775807, 2);  unsqueeze_30 = None
        ...
        cat_4: "f32[16, 8, 512, 16, 2]" = torch.ops.aten.cat.default([unsqueeze_31, unsqueeze_32], -1);  unsqueeze_31 = unsqueeze_32 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:1003 in forward, code: rotated = rotated.flatten(-2)
        view_54: "f32[16, 8, 512, 32]" = torch.ops.aten.view.default(cat_4, [16, 8, 512, 32]);  cat_4 = None
        ...
        slice_40: "f32[16, 1, 512, 16]" = torch.ops.aten.slice.Tensor(unsqueeze_26, 3, 1, 9223372036854775807, 2);  unsqueeze_26 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:999 in forward, code: rotated_x_even = x_even * cos_even - x_odd * sin_even
        mul_34: "f32[16, 1, 512, 16]" = torch.ops.aten.mul.Tensor(slice_39, slice_35)
        mul_35: "f32[16, 1, 512, 16]" = torch.ops.aten.mul.Tensor(slice_40, slice_36)
        sub_7: "f32[16, 1, 512, 16]" = torch.ops.aten.sub.Tensor(mul_34, mul_35);  mul_34 = mul_35 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:1000 in forward, code: rotated_x_odd = x_even * sin_even + x_odd * cos_even
        mul_36: "f32[16, 1, 512, 16]" = torch.ops.aten.mul.Tensor(slice_39, slice_36);  slice_39 = None
        mul_37: "f32[16, 1, 512, 16]" = torch.ops.aten.mul.Tensor(slice_40, slice_35);  slice_40 = None
        ...
        cat_5: "f32[16, 1, 512, 16, 2]" = torch.ops.aten.cat.default([unsqueeze_37, unsqueeze_38], -1);  unsqueeze_37 = unsqueeze_38 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:1003 in forward, code: rotated = rotated.flatten(-2)
        view_55: "f32[16, 1, 512, 32]" = torch.ops.aten.view.default(cat_5, [16, 1, 512, 32]);  cat_5 = None
        ...
        view_56: "f32[128, 512, 32]" = torch.ops.aten.view.default(expand_8, [128, 512, 32]);  expand_8 = None
        ...
        view_57: "f32[128, 32, 512]" = torch.ops.aten.view.default(clone_3, [128, 32, 512]);  clone_3 = None
        bmm_4: "f32[128, 512, 512]" = torch.ops.aten.bmm.default(view_56, view_57)
        view_58: "f32[16, 8, 512, 512]" = torch.ops.aten.view.default(bmm_4, [16, 8, 512, 512]);  bmm_4 = None
        ...
        view_59: "f32[128, 512, 512]" = torch.ops.aten.view.default(expand_10, [128, 512, 512]);  expand_10 = None
        expand_11: "f32[16, 8, 512, 32]" = torch.ops.aten.expand.default(view_53, [16, 8, 512, 32]);  view_53 = None
        view_60: "f32[128, 512, 32]" = torch.ops.aten.view.default(expand_11, [128, 512, 32]);  expand_11 = None
        bmm_5: "f32[128, 512, 32]" = torch.ops.aten.bmm.default(view_59, view_60);  view_59 = None
        view_61: "f32[16, 8, 512, 32]" = torch.ops.aten.view.default(bmm_5, [16, 8, 512, 32]);  bmm_5 = None
        view_62: "f32[16, 512, 256]" = torch.ops.aten.view.default(view_61, [16, -1, 256]);  view_61 = None
        ...
        mul_39: "f32[16, 512, 256]" = torch.ops.aten.mul.Tensor(mul_38, primals_48);  mul_38 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:820 in forward, code: x = torch.mul(F.silu(self.swiglu_linear(x)), self.swiglu_gate_linear(x))
        view_63: "f32[8192, 256]" = torch.ops.aten.view.default(mul_39, [8192, 256])
        ...
        view_64: "f32[16, 512, 682]" = torch.ops.aten.view.default(addmm_15, [16, 512, 682])
        ...
        view_66: "f32[16, 512, 682]" = torch.ops.aten.view.default(addmm_16, [16, 512, 682])
        mul_41: "f32[16, 512, 682]" = torch.ops.aten.mul.Tensor(mul_40, view_66);  mul_40 = view_66 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:821 in forward, code: x = self.linear_out(x)
        view_67: "f32[8192, 682]" = torch.ops.aten.view.default(mul_41, [8192, 682]);  mul_41 = None
        ...
        view_68: "f32[16, 512, 256]" = torch.ops.aten.view.default(addmm_17, [16, 512, 256]);  addmm_17 = None
        ...
        mul_43: "f32[16, 512, 256]" = torch.ops.aten.mul.Tensor(mul_42, primals_55);  mul_42 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:94 in forward, code: q = self.linearQ(x)
        view_69: "f32[8192, 256]" = torch.ops.aten.view.default(mul_43, [8192, 256]);  mul_43 = None
        ...
        view_70: "f32[16, 512, 256]" = torch.ops.aten.view.default(addmm_18, [16, 512, 256]);  addmm_18 = None
        ...
        view_72: "f32[16, 512, 32]" = torch.ops.aten.view.default(addmm_19, [16, 512, 32]);  addmm_19 = None
        ...
        view_74: "f32[16, 512, 256]" = torch.ops.aten.view.default(addmm_20, [16, 512, 256]);  addmm_20 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:536 in forward, code: q = q.view(b, self.n_heads, q_l, self.d_head)
        view_75: "f32[16, 8, 512, 32]" = torch.ops.aten.view.default(view_70, [16, 8, 512, 32]);  view_70 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:537 in forward, code: k = k.unsqueeze(1)
        unsqueeze_39: "f32[16, 1, 512, 32]" = torch.ops.aten.unsqueeze.default(view_72, 1);  view_72 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:538 in forward, code: v = v.view(b, self.n_heads, v_l, self.d_head)
        view_76: "f32[16, 8, 512, 32]" = torch.ops.aten.view.default(view_74, [16, 8, 512, 32]);  view_74 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:977 in forward, code: cos = self.rope_cos[:x.shape[2]]
        slice_45: "f16[512, 32]" = torch.ops.aten.slice.Tensor(primals_62, 0, 0, 512);  primals_62 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:978 in forward, code: sin = self.rope_sin[:x.shape[2]]
        slice_46: "f16[512, 32]" = torch.ops.aten.slice.Tensor(primals_63, 0, 0, 512);  primals_63 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:990 in forward, code: cos = cos.unsqueeze(0).unsqueeze(0)
        unsqueeze_40: "f16[1, 512, 32]" = torch.ops.aten.unsqueeze.default(slice_45, 0);  slice_45 = None
        unsqueeze_41: "f16[1, 1, 512, 32]" = torch.ops.aten.unsqueeze.default(unsqueeze_40, 0);  unsqueeze_40 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:991 in forward, code: sin = sin.unsqueeze(0).unsqueeze(0)
        unsqueeze_42: "f16[1, 512, 32]" = torch.ops.aten.unsqueeze.default(slice_46, 0);  slice_46 = None
        unsqueeze_43: "f16[1, 1, 512, 32]" = torch.ops.aten.unsqueeze.default(unsqueeze_42, 0);  unsqueeze_42 = None
        ...
        slice_48: "f32[16, 8, 512, 16]" = torch.ops.aten.slice.Tensor(view_75, 3, 1, 9223372036854775807, 2);  view_75 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:996 in forward, code: cos_even = cos[..., 0::2]
        slice_49: "f16[1, 1, 512, 16]" = torch.ops.aten.slice.Tensor(unsqueeze_41, 3, 0, 9223372036854775807, 2);  unsqueeze_41 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:997 in forward, code: sin_even = sin[..., 0::2]
        slice_50: "f16[1, 1, 512, 16]" = torch.ops.aten.slice.Tensor(unsqueeze_43, 3, 0, 9223372036854775807, 2);  unsqueeze_43 = None
        ...
        cat_6: "f32[16, 8, 512, 16, 2]" = torch.ops.aten.cat.default([unsqueeze_44, unsqueeze_45], -1);  unsqueeze_44 = unsqueeze_45 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:1003 in forward, code: rotated = rotated.flatten(-2)
        view_77: "f32[16, 8, 512, 32]" = torch.ops.aten.view.default(cat_6, [16, 8, 512, 32]);  cat_6 = None
        ...
        slice_54: "f32[16, 1, 512, 16]" = torch.ops.aten.slice.Tensor(unsqueeze_39, 3, 1, 9223372036854775807, 2);  unsqueeze_39 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:999 in forward, code: rotated_x_even = x_even * cos_even - x_odd * sin_even
        mul_48: "f32[16, 1, 512, 16]" = torch.ops.aten.mul.Tensor(slice_53, slice_49)
        mul_49: "f32[16, 1, 512, 16]" = torch.ops.aten.mul.Tensor(slice_54, slice_50)
        sub_10: "f32[16, 1, 512, 16]" = torch.ops.aten.sub.Tensor(mul_48, mul_49);  mul_48 = mul_49 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:1000 in forward, code: rotated_x_odd = x_even * sin_even + x_odd * cos_even
        mul_50: "f32[16, 1, 512, 16]" = torch.ops.aten.mul.Tensor(slice_53, slice_50);  slice_53 = None
        mul_51: "f32[16, 1, 512, 16]" = torch.ops.aten.mul.Tensor(slice_54, slice_49);  slice_54 = None
        ...
        cat_7: "f32[16, 1, 512, 16, 2]" = torch.ops.aten.cat.default([unsqueeze_50, unsqueeze_51], -1);  unsqueeze_50 = unsqueeze_51 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:1003 in forward, code: rotated = rotated.flatten(-2)
        view_78: "f32[16, 1, 512, 32]" = torch.ops.aten.view.default(cat_7, [16, 1, 512, 32]);  cat_7 = None
        ...
        view_79: "f32[128, 512, 32]" = torch.ops.aten.view.default(expand_12, [128, 512, 32]);  expand_12 = None
        ...
        view_80: "f32[128, 32, 512]" = torch.ops.aten.view.default(clone_4, [128, 32, 512]);  clone_4 = None
        bmm_6: "f32[128, 512, 512]" = torch.ops.aten.bmm.default(view_79, view_80)
        view_81: "f32[16, 8, 512, 512]" = torch.ops.aten.view.default(bmm_6, [16, 8, 512, 512]);  bmm_6 = None
        ...
        view_82: "f32[128, 512, 512]" = torch.ops.aten.view.default(expand_14, [128, 512, 512]);  expand_14 = None
        expand_15: "f32[16, 8, 512, 32]" = torch.ops.aten.expand.default(view_76, [16, 8, 512, 32]);  view_76 = None
        view_83: "f32[128, 512, 32]" = torch.ops.aten.view.default(expand_15, [128, 512, 32]);  expand_15 = None
        bmm_7: "f32[128, 512, 32]" = torch.ops.aten.bmm.default(view_82, view_83);  view_82 = None
        view_84: "f32[16, 8, 512, 32]" = torch.ops.aten.view.default(bmm_7, [16, 8, 512, 32]);  bmm_7 = None
        view_85: "f32[16, 512, 256]" = torch.ops.aten.view.default(view_84, [16, -1, 256]);  view_84 = None
        ...
        mul_53: "f32[16, 512, 256]" = torch.ops.aten.mul.Tensor(mul_52, primals_65);  mul_52 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:820 in forward, code: x = torch.mul(F.silu(self.swiglu_linear(x)), self.swiglu_gate_linear(x))
        view_86: "f32[8192, 256]" = torch.ops.aten.view.default(mul_53, [8192, 256])
        ...
        view_87: "f32[16, 512, 682]" = torch.ops.aten.view.default(addmm_21, [16, 512, 682])
        ...
        view_89: "f32[16, 512, 682]" = torch.ops.aten.view.default(addmm_22, [16, 512, 682])
        mul_55: "f32[16, 512, 682]" = torch.ops.aten.mul.Tensor(mul_54, view_89);  mul_54 = view_89 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:821 in forward, code: x = self.linear_out(x)
        view_90: "f32[8192, 682]" = torch.ops.aten.view.default(mul_55, [8192, 682]);  mul_55 = None
        ...
        view_91: "f32[16, 512, 256]" = torch.ops.aten.view.default(addmm_23, [16, 512, 256]);  addmm_23 = None
        ...
        view_92: "f32[8192, 256]" = torch.ops.aten.view.default(mul_57, [8192, 256]);  mul_57 = None
        ...
        view_93: "f32[16, 512, 10000]" = torch.ops.aten.view.default(addmm_24, [16, 512, 10000]);  addmm_24 = None
