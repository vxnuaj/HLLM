class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[10000, 256]", primals_2: "i64[16, 1]", primals_3: "f32[1, 512, 256]", primals_4: "f32[256]", primals_5: "f32[256, 256]", primals_6: "f32[256]", primals_7: "f32[32, 256]", primals_8: "f32[32]", primals_9: "f32[256, 256]", primals_10: "f32[256]", primals_11: "f16[16, 512, 32]", primals_12: "f16[16, 512, 256]", primals_13: "f16[512, 32]", primals_14: "f16[512, 32]", primals_15: "b8[1, 1, 512, 512]", primals_16: "f32[256]", primals_17: "f32[682, 256]", primals_18: "f32[682]", primals_19: "f32[682, 256]", primals_20: "f32[682]", primals_21: "f32[256, 682]", primals_22: "f32[256]", primals_23: "f32[256]", primals_24: "f32[256, 256]", primals_25: "f32[256]", primals_26: "f32[32, 256]", primals_27: "f32[32]", primals_28: "f32[256, 256]", primals_29: "f32[256]", primals_30: "f16[16, 512, 32]", primals_31: "f16[16, 512, 256]", primals_32: "f16[512, 32]", primals_33: "f16[512, 32]", primals_34: "b8[1, 1, 512, 512]", primals_35: "f32[256]", primals_36: "f32[682, 256]", primals_37: "f32[682]", primals_38: "f32[682, 256]", primals_39: "f32[682]", primals_40: "f32[256, 682]", primals_41: "f32[256]", primals_42: "f32[256]", primals_43: "f32[256, 256]", primals_44: "f32[256]", primals_45: "f32[32, 256]", primals_46: "f32[32]", primals_47: "f32[256, 256]", primals_48: "f32[256]", primals_49: "f16[16, 512, 32]", primals_50: "f16[16, 512, 256]", primals_51: "f16[512, 32]", primals_52: "f16[512, 32]", primals_53: "b8[1, 1, 512, 512]", primals_54: "f32[256]", primals_55: "f32[682, 256]", primals_56: "f32[682]", primals_57: "f32[682, 256]", primals_58: "f32[682]", primals_59: "f32[256, 682]", primals_60: "f32[256]", primals_61: "f32[256]", primals_62: "f32[256, 256]", primals_63: "f32[256]", primals_64: "f32[32, 256]", primals_65: "f32[32]", primals_66: "f32[256, 256]", primals_67: "f32[256]", primals_68: "f16[16, 512, 32]", primals_69: "f16[16, 512, 256]", primals_70: "f16[512, 32]", primals_71: "f16[512, 32]", primals_72: "b8[1, 1, 512, 512]", primals_73: "f32[256]", primals_74: "f32[682, 256]", primals_75: "f32[682]", primals_76: "f32[682, 256]", primals_77: "f32[682]", primals_78: "f32[256, 682]", primals_79: "f32[256]", primals_80: "f32[256]", primals_81: "f32[10000]"):
        ...
        view: "f32[16, 256]" = torch.ops.aten.reshape.default(mul_1, [16, 256]);  mul_1 = None
        ...
        view_1: "f32[16, 1, 256]" = torch.ops.aten.reshape.default(addmm, [16, 1, 256]);  addmm = None
        ...
        view_3: "f32[16, 1, 32]" = torch.ops.aten.reshape.default(addmm_1, [16, 1, 32]);  addmm_1 = None
        ...
        view_5: "f32[16, 1, 256]" = torch.ops.aten.reshape.default(addmm_2, [16, 1, 256]);  addmm_2 = None
        ...
        view_6: "f32[16, 8, 1, 32]" = torch.ops.aten.reshape.default(view_1, [16, 8, 1, 32]);  view_1 = None
        ...
        view_7: "f32[16, 8, 512, 32]" = torch.ops.aten.reshape.default(slice_7, [16, 8, 512, 32])
        ...
        view_8: "f32[16, 8, 1, 32]" = torch.ops.aten.reshape.default(cat_2, [16, 8, 1, 32]);  cat_2 = None
        ...
        cat_3: "f32[16, 1, 512, 16, 2]" = torch.ops.aten.cat.default([unsqueeze_11, unsqueeze_12], -1);  unsqueeze_11 = unsqueeze_12 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:1003 in forward, code: rotated = rotated.flatten(-2)
        view_9: "f32[16, 1, 512, 32]" = torch.ops.aten.reshape.default(cat_3, [16, 1, 512, 32]);  cat_3 = None
        ...
        view_10: "f32[128, 1, 32]" = torch.ops.aten.reshape.default(expand, [128, 1, 32]);  expand = None
        ...
        view_12: "f32[16, 8, 1, 512]" = torch.ops.aten.reshape.default(bmm, [16, 8, 1, 512]);  bmm = None
        ...
        view_13: "f32[128, 1, 512]" = torch.ops.aten.reshape.default(expand_2, [128, 1, 512]);  expand_2 = None
        ...
        view_14: "f32[128, 512, 32]" = torch.ops.aten.reshape.default(clone_2, [128, 512, 32]);  clone_2 = None
        bmm_1: "f32[128, 1, 32]" = torch.ops.aten.bmm.default(view_13, view_14);  view_13 = None
        view_15: "f32[16, 8, 1, 32]" = torch.ops.aten.reshape.default(bmm_1, [16, 8, 1, 32]);  bmm_1 = None
        view_16: "f32[16, 1, 256]" = torch.ops.aten.reshape.default(view_15, [16, -1, 256]);  view_15 = None
        ...
        view_17: "f32[16, 256]" = torch.ops.aten.reshape.default(mul_11, [16, 256])
        ...
        view_18: "f32[16, 1, 682]" = torch.ops.aten.reshape.default(addmm_3, [16, 1, 682])
        ...
        view_20: "f32[16, 1, 682]" = torch.ops.aten.reshape.default(addmm_4, [16, 1, 682])
        ...
        view_21: "f32[16, 682]" = torch.ops.aten.reshape.default(mul_13, [16, 682]);  mul_13 = None
        ...
        view_22: "f32[16, 1, 256]" = torch.ops.aten.reshape.default(addmm_5, [16, 1, 256]);  addmm_5 = None
        ...
        mul_15: "f32[16, 1, 256]" = torch.ops.aten.mul.Tensor(mul_14, primals_23);  mul_14 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:94 in forward, code: q = self.linearQ(x)
        view_23: "f32[16, 256]" = torch.ops.aten.reshape.default(mul_15, [16, 256]);  mul_15 = None
        ...
        view_24: "f32[16, 1, 256]" = torch.ops.aten.reshape.default(addmm_6, [16, 1, 256]);  addmm_6 = None
        ...
        view_26: "f32[16, 1, 32]" = torch.ops.aten.reshape.default(addmm_7, [16, 1, 32]);  addmm_7 = None
        ...
        view_28: "f32[16, 1, 256]" = torch.ops.aten.reshape.default(addmm_8, [16, 1, 256]);  addmm_8 = None
        ...
        slice_28: "f32[16, 512, 256]" = torch.ops.aten.slice.Tensor(cat_5, 1, -512, 9223372036854775807);  cat_5 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:536 in forward, code: q = q.view(b, self.n_heads, q_l, self.d_head)
        view_29: "f32[16, 8, 1, 32]" = torch.ops.aten.reshape.default(view_24, [16, 8, 1, 32]);  view_24 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:537 in forward, code: k = k.unsqueeze(1)
        unsqueeze_13: "f32[16, 1, 512, 32]" = torch.ops.aten.unsqueeze.default(slice_25, 1)
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:538 in forward, code: v = v.view(b, self.n_heads, v_l, self.d_head)
        view_30: "f32[16, 8, 512, 32]" = torch.ops.aten.reshape.default(slice_28, [16, 8, 512, 32])
        ...
        cat_6: "f32[16, 8, 1, 16, 2]" = torch.ops.aten.cat.default([unsqueeze_18, unsqueeze_19], -1);  unsqueeze_18 = unsqueeze_19 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:1003 in forward, code: rotated = rotated.flatten(-2)
        view_31: "f32[16, 8, 1, 32]" = torch.ops.aten.reshape.default(cat_6, [16, 8, 1, 32]);  cat_6 = None
        ...
        cat_7: "f32[16, 1, 512, 16, 2]" = torch.ops.aten.cat.default([unsqueeze_24, unsqueeze_25], -1);  unsqueeze_24 = unsqueeze_25 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:1003 in forward, code: rotated = rotated.flatten(-2)
        view_32: "f32[16, 1, 512, 32]" = torch.ops.aten.reshape.default(cat_7, [16, 1, 512, 32]);  cat_7 = None
        ...
        view_33: "f32[128, 1, 32]" = torch.ops.aten.reshape.default(expand_4, [128, 1, 32]);  expand_4 = None
        ...
        view_34: "f32[128, 32, 512]" = torch.ops.aten.reshape.default(clone_3, [128, 32, 512]);  clone_3 = None
        bmm_2: "f32[128, 1, 512]" = torch.ops.aten.bmm.default(view_33, view_34)
        view_35: "f32[16, 8, 1, 512]" = torch.ops.aten.reshape.default(bmm_2, [16, 8, 1, 512]);  bmm_2 = None
        ...
        view_36: "f32[128, 1, 512]" = torch.ops.aten.reshape.default(expand_6, [128, 1, 512]);  expand_6 = None
        ...
        view_37: "f32[128, 512, 32]" = torch.ops.aten.reshape.default(clone_4, [128, 512, 32]);  clone_4 = None
        bmm_3: "f32[128, 1, 32]" = torch.ops.aten.bmm.default(view_36, view_37);  view_36 = None
        view_38: "f32[16, 8, 1, 32]" = torch.ops.aten.reshape.default(bmm_3, [16, 8, 1, 32]);  bmm_3 = None
        view_39: "f32[16, 1, 256]" = torch.ops.aten.reshape.default(view_38, [16, -1, 256]);  view_38 = None
        ...
        mul_25: "f32[16, 1, 256]" = torch.ops.aten.mul.Tensor(mul_24, primals_35);  mul_24 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:820 in forward, code: x = torch.mul(F.silu(self.swiglu_linear(x)), self.swiglu_gate_linear(x))
        view_40: "f32[16, 256]" = torch.ops.aten.reshape.default(mul_25, [16, 256])
        ...
        view_41: "f32[16, 1, 682]" = torch.ops.aten.reshape.default(addmm_9, [16, 1, 682])
        ...
        view_43: "f32[16, 1, 682]" = torch.ops.aten.reshape.default(addmm_10, [16, 1, 682])
        mul_27: "f32[16, 1, 682]" = torch.ops.aten.mul.Tensor(mul_26, view_43);  mul_26 = view_43 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:821 in forward, code: x = self.linear_out(x)
        view_44: "f32[16, 682]" = torch.ops.aten.reshape.default(mul_27, [16, 682]);  mul_27 = None
        ...
        view_45: "f32[16, 1, 256]" = torch.ops.aten.reshape.default(addmm_11, [16, 1, 256]);  addmm_11 = None
        ...
        mul_29: "f32[16, 1, 256]" = torch.ops.aten.mul.Tensor(mul_28, primals_42);  mul_28 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:94 in forward, code: q = self.linearQ(x)
        view_46: "f32[16, 256]" = torch.ops.aten.reshape.default(mul_29, [16, 256]);  mul_29 = None
        ...
        view_47: "f32[16, 1, 256]" = torch.ops.aten.reshape.default(addmm_12, [16, 1, 256]);  addmm_12 = None
        ...
        view_49: "f32[16, 1, 32]" = torch.ops.aten.reshape.default(addmm_13, [16, 1, 32]);  addmm_13 = None
        ...
        view_51: "f32[16, 1, 256]" = torch.ops.aten.reshape.default(addmm_14, [16, 1, 256]);  addmm_14 = None
        ...
        slice_49: "f32[16, 512, 256]" = torch.ops.aten.slice.Tensor(cat_9, 1, -512, 9223372036854775807);  cat_9 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:536 in forward, code: q = q.view(b, self.n_heads, q_l, self.d_head)
        view_52: "f32[16, 8, 1, 32]" = torch.ops.aten.reshape.default(view_47, [16, 8, 1, 32]);  view_47 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:537 in forward, code: k = k.unsqueeze(1)
        unsqueeze_26: "f32[16, 1, 512, 32]" = torch.ops.aten.unsqueeze.default(slice_46, 1)
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:538 in forward, code: v = v.view(b, self.n_heads, v_l, self.d_head)
        view_53: "f32[16, 8, 512, 32]" = torch.ops.aten.reshape.default(slice_49, [16, 8, 512, 32])
        ...
        cat_10: "f32[16, 8, 1, 16, 2]" = torch.ops.aten.cat.default([unsqueeze_31, unsqueeze_32], -1);  unsqueeze_31 = unsqueeze_32 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:1003 in forward, code: rotated = rotated.flatten(-2)
        view_54: "f32[16, 8, 1, 32]" = torch.ops.aten.reshape.default(cat_10, [16, 8, 1, 32]);  cat_10 = None
        ...
        cat_11: "f32[16, 1, 512, 16, 2]" = torch.ops.aten.cat.default([unsqueeze_37, unsqueeze_38], -1);  unsqueeze_37 = unsqueeze_38 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:1003 in forward, code: rotated = rotated.flatten(-2)
        view_55: "f32[16, 1, 512, 32]" = torch.ops.aten.reshape.default(cat_11, [16, 1, 512, 32]);  cat_11 = None
        ...
        view_56: "f32[128, 1, 32]" = torch.ops.aten.reshape.default(expand_8, [128, 1, 32]);  expand_8 = None
        ...
        view_57: "f32[128, 32, 512]" = torch.ops.aten.reshape.default(clone_5, [128, 32, 512]);  clone_5 = None
        bmm_4: "f32[128, 1, 512]" = torch.ops.aten.bmm.default(view_56, view_57)
        view_58: "f32[16, 8, 1, 512]" = torch.ops.aten.reshape.default(bmm_4, [16, 8, 1, 512]);  bmm_4 = None
        ...
        view_59: "f32[128, 1, 512]" = torch.ops.aten.reshape.default(expand_10, [128, 1, 512]);  expand_10 = None
        ...
        view_60: "f32[128, 512, 32]" = torch.ops.aten.reshape.default(clone_6, [128, 512, 32]);  clone_6 = None
        bmm_5: "f32[128, 1, 32]" = torch.ops.aten.bmm.default(view_59, view_60);  view_59 = None
        view_61: "f32[16, 8, 1, 32]" = torch.ops.aten.reshape.default(bmm_5, [16, 8, 1, 32]);  bmm_5 = None
        view_62: "f32[16, 1, 256]" = torch.ops.aten.reshape.default(view_61, [16, -1, 256]);  view_61 = None
        ...
        mul_39: "f32[16, 1, 256]" = torch.ops.aten.mul.Tensor(mul_38, primals_54);  mul_38 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:820 in forward, code: x = torch.mul(F.silu(self.swiglu_linear(x)), self.swiglu_gate_linear(x))
        view_63: "f32[16, 256]" = torch.ops.aten.reshape.default(mul_39, [16, 256])
        ...
        view_64: "f32[16, 1, 682]" = torch.ops.aten.reshape.default(addmm_15, [16, 1, 682])
        ...
        view_66: "f32[16, 1, 682]" = torch.ops.aten.reshape.default(addmm_16, [16, 1, 682])
        mul_41: "f32[16, 1, 682]" = torch.ops.aten.mul.Tensor(mul_40, view_66);  mul_40 = view_66 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:821 in forward, code: x = self.linear_out(x)
        view_67: "f32[16, 682]" = torch.ops.aten.reshape.default(mul_41, [16, 682]);  mul_41 = None
        ...
        view_68: "f32[16, 1, 256]" = torch.ops.aten.reshape.default(addmm_17, [16, 1, 256]);  addmm_17 = None
        ...
        mul_43: "f32[16, 1, 256]" = torch.ops.aten.mul.Tensor(mul_42, primals_61);  mul_42 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:94 in forward, code: q = self.linearQ(x)
        view_69: "f32[16, 256]" = torch.ops.aten.reshape.default(mul_43, [16, 256]);  mul_43 = None
        ...
        view_70: "f32[16, 1, 256]" = torch.ops.aten.reshape.default(addmm_18, [16, 1, 256]);  addmm_18 = None
        ...
        view_72: "f32[16, 1, 32]" = torch.ops.aten.reshape.default(addmm_19, [16, 1, 32]);  addmm_19 = None
        ...
        view_74: "f32[16, 1, 256]" = torch.ops.aten.reshape.default(addmm_20, [16, 1, 256]);  addmm_20 = None
        ...
        slice_70: "f32[16, 512, 256]" = torch.ops.aten.slice.Tensor(cat_13, 1, -512, 9223372036854775807);  cat_13 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:536 in forward, code: q = q.view(b, self.n_heads, q_l, self.d_head)
        view_75: "f32[16, 8, 1, 32]" = torch.ops.aten.reshape.default(view_70, [16, 8, 1, 32]);  view_70 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:537 in forward, code: k = k.unsqueeze(1)
        unsqueeze_39: "f32[16, 1, 512, 32]" = torch.ops.aten.unsqueeze.default(slice_67, 1)
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:538 in forward, code: v = v.view(b, self.n_heads, v_l, self.d_head)
        view_76: "f32[16, 8, 512, 32]" = torch.ops.aten.reshape.default(slice_70, [16, 8, 512, 32])
        ...
        cat_14: "f32[16, 8, 1, 16, 2]" = torch.ops.aten.cat.default([unsqueeze_44, unsqueeze_45], -1);  unsqueeze_44 = unsqueeze_45 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:1003 in forward, code: rotated = rotated.flatten(-2)
        view_77: "f32[16, 8, 1, 32]" = torch.ops.aten.reshape.default(cat_14, [16, 8, 1, 32]);  cat_14 = None
        ...
        cat_15: "f32[16, 1, 512, 16, 2]" = torch.ops.aten.cat.default([unsqueeze_50, unsqueeze_51], -1);  unsqueeze_50 = unsqueeze_51 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:1003 in forward, code: rotated = rotated.flatten(-2)
        view_78: "f32[16, 1, 512, 32]" = torch.ops.aten.reshape.default(cat_15, [16, 1, 512, 32]);  cat_15 = None
        ...
        view_79: "f32[128, 1, 32]" = torch.ops.aten.reshape.default(expand_12, [128, 1, 32]);  expand_12 = None
        ...
        view_80: "f32[128, 32, 512]" = torch.ops.aten.reshape.default(clone_7, [128, 32, 512]);  clone_7 = None
        bmm_6: "f32[128, 1, 512]" = torch.ops.aten.bmm.default(view_79, view_80)
        view_81: "f32[16, 8, 1, 512]" = torch.ops.aten.reshape.default(bmm_6, [16, 8, 1, 512]);  bmm_6 = None
        ...
        view_82: "f32[128, 1, 512]" = torch.ops.aten.reshape.default(expand_14, [128, 1, 512]);  expand_14 = None
        ...
        view_83: "f32[128, 512, 32]" = torch.ops.aten.reshape.default(clone_8, [128, 512, 32]);  clone_8 = None
        bmm_7: "f32[128, 1, 32]" = torch.ops.aten.bmm.default(view_82, view_83);  view_82 = None
        view_84: "f32[16, 8, 1, 32]" = torch.ops.aten.reshape.default(bmm_7, [16, 8, 1, 32]);  bmm_7 = None
        view_85: "f32[16, 1, 256]" = torch.ops.aten.reshape.default(view_84, [16, -1, 256]);  view_84 = None
        ...
        mul_53: "f32[16, 1, 256]" = torch.ops.aten.mul.Tensor(mul_52, primals_73);  mul_52 = None
         ...
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:820 in forward, code: x = torch.mul(F.silu(self.swiglu_linear(x)), self.swiglu_gate_linear(x))
        view_86: "f32[16, 256]" = torch.ops.aten.reshape.default(mul_53, [16, 256])
        ...
        view_87: "f32[16, 1, 682]" = torch.ops.aten.reshape.default(addmm_21, [16, 1, 682])
        ...
        view_89: "f32[16, 1, 682]" = torch.ops.aten.reshape.default(addmm_22, [16, 1, 682])
        mul_55: "f32[16, 1, 682]" = torch.ops.aten.mul.Tensor(mul_54, view_89);  mul_54 = view_89 = None
        
         # File: /Users/juanvera/Documents/DEVELOPMENT/SINGULARITY/DEEPLEARNING/BUILDING/HLLM/model/blocks.py:821 in forward, code: x = self.linear_out(x)
        view_90: "f32[16, 682]" = torch.ops.aten.reshape.default(mul_55, [16, 682]);  mul_55 = None
        ...
        view_91: "f32[16, 1, 256]" = torch.ops.aten.reshape.default(addmm_23, [16, 1, 256]);  addmm_23 = None
        ...
        view_92: "f32[16, 256]" = torch.ops.aten.reshape.default(mul_57, [16, 256]);  mul_57 = None
        ...
        view_93: "f32[16, 1, 10000]" = torch.ops.aten.reshape.default(addmm_24, [16, 1, 10000]);  addmm_24 = None
